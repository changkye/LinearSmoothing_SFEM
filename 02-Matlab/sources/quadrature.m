function [W,Q] = quadrature(quadorder,qt,sdim)
    ...
    if nargin < 3 % set default arguments
        if strcmp(qt,'GAUSS') == 1; dim = 1; else; dim = 2; end 
    end  
  
    if nargin < 2; type = 'GAUSS'; end 
    ...
    if strcmp(qt,'GAUSS') == 1
        ...
        quadpoint  = zeros(quadorder^sdim,sdim); quadweight = zeros(quadorder^sdim,1);
        ...
        switch quadorder
            ...
            case 2
                % points
                r1pt(1) =  0.577350269189626; r1pt(2) = -0.577350269189626;
                % weights
                r1wt(1) =  1.000000000000000; r1wt(2) =  1.000000000000000;         
    ...
    elseif strcmp(qt,'TRIANGULAR') == 1
        ...
        if sdim == 3  %%% TETRAHEDRA
            ...
            elseif quadorder == 2
                ...
                % weights
                quadweight = [0.3333333333333; 0.3333333333333; 0.3333333333333];

                
            elseif quadorder == 3 % quadorder 3 and 4 by CK
                quadpoint = zeros(4,2);
                quadweight = zeros(4,1); 
                % points
                quadpoint(1,:) = [0.3333333333333 0.3333333333333];
                quadpoint(2,:) = [0.2000000000000 0.2000000000000];
                quadpoint(3,:) = [0.2000000000000 0.6000000000000];
                quadpoint(4,:) = [0.6000000000000 0.2000000000000];
                % weights
                quadweight = [-0.5625000000000; 0.5208333333333; 0.5208333333333; 0.5208333333333];

            elseif quadorder == 4
                quadpoint = zeros(6,2);
                quadweight = zeros(6,1);
                % points
                quadpoint = [0.44594849091597 0.44594849091597;
                ...
                % weights
                quadweight = [0.22338158967801; 0.22338158967801; 0.22338158967801;
            ...
            elseif quadorder == 5
                ...
                % weights
                quadweight = [0.0533472356088; 0.0533472356088; 0.0533472356088; 0.0771137608903;
                            0.0771137608903; 0.0771137608903; 0.0771137608903; 0.0771137608903;
                            0.0771137608903; 0.1756152576332; 0.1756152576332; 0.1756152576332;
                            -0.1495700444677];
