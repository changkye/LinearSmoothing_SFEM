                                                                        ...
                                                                        const Eigen::Vector2d &material)
{
    ...
    const Eigen::Matrix<double, 2, 2> limits =
        (Eigen::Matrix<double, 2, 2>() << 0.0, geometry.L,
         0.0, geometry.H)
            .finished();
    ...
    problem.bc = bc_builder.make_from_exact_field(problem.mesh.nodes, field.exact_not_so_simple_shear(problem.mesh.nodes));
