...
% fem
fem1 = load('./NonlinearFEM2D_T6_Comp_DBC_2x2.mat');
fem2 = load('./NonlinearFEM2D_T6_Comp_DBC_4x4.mat');
fem3 = load('./NonlinearFEM2D_T6_Comp_DBC_6x6.mat');
fem4 = load('./NonlinearFEM2D_T6_Comp_DBC_8x8.mat');
fem5 = load('./NonlinearFEM2D_T6_Comp_DBC_10x10.mat');
...
% csfem
csfem1 = load('./NonlinearSFEM2D_cell_T6_Comp_DBC_2x2.mat');
csfem2 = load('./NonlinearSFEM2D_cell_T6_Comp_DBC_4x4.mat');
csfem3 = load('./NonlinearSFEM2D_cell_T6_Comp_DBC_6x6.mat');
csfem4 = load('./NonlinearSFEM2D_cell_T6_Comp_DBC_8x8.mat');
csfem5 = load('./NonlinearSFEM2D_cell_T6_Comp_DBC_10x10.mat');
...
figure
    hold on
    plot(abs(log10(h)),log10(fem_dbc_relerrdisp),'ko-','MarkerSize',10);
%     plot(abs(log10(h)),log10(fem_nbc_relerrdisp),'ko-.','MarkerSize',10,'MarkerFaceColor','k')
...
%     plot(abs(log10(h)),log10(csfem_nbc_relerrdisp),'b^-.','MarkerSize',10,'MarkerFaceColor','b');
    ...
    xlabel('|log(1/h)|','interpreter','latex','FontSize',14);
    ylabel('log(U_{relative error})','interpreter','latex','FontSize',14);
