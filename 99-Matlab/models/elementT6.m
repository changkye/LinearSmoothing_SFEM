function [Nodes,Elements] = elementT6(L,numEls)
	% 
	xn = 2*numEls(1) + 1;
	yn = 2*numEls(2) + 1;
	...
	ic = 2; jc = 2*xn;
	idx1 = [1 3 2*xn+1 2 xn+2 xn+1];
	idx2 = [3 2*xn+3 2*xn+1 xn+3 2*xn+2 xn+2];
	Elements = [makeConnectivity(numEls,ic,jc,idx1); 
		makeConnectivity(numEls,ic,jc,idx2)];
