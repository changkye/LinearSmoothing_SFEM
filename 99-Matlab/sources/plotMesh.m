function plotMesh(X,connect,elem_type,lineColour,textLineWidth,valueLineWidth)
    ...
    if nargin < 6; textLineWidth = 'LineWidth'; valueLineWidth = 1; end
    ...
    for e = 1:size(connect,1)
        ...
        plot3(xpt,ypt,zpt,lineColour,textLineWidth,valueLineWidth)
    end
